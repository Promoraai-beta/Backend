...
# Clear any cached Prisma client and force regeneration to ensure all models are included
# Use schema.prisma modification time to bust cache when schema changes
